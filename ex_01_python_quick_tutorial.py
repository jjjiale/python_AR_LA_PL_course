...
print("_"*50)
lst_2 = list(map(chr, range(100, 120)))
print(lst_2)
print("_"*50)
print("[3:6]->{}".format(lst_2[3:6]))
print("[-3:-1]->{}".format(lst_2[-4:-1]))
print("[-3:]->{}".format(lst_2[-4:]))
print("[:3]->{}".format(lst_2[:4]))
print("[:]->{}".format(lst_2[:]))
print("_"*50)
help(map)
...
print(lst_2)
print("_"*50)
print("[0:10:2]->{}".format(lst_2[0:9:2]))
print("[::3]->{}".format(lst_2[::3]))
print("[9:3:-2]->{}".format(lst_2[8:5:-2]))
print("[20:3:-2]->{}".format(lst_2[18:2:-2]))
print("[7::-2]->{}".format(lst_2[6::-2]))
...
print("_"*50)
lst_2[5] = "龙"
print("lst_2[5]=龙->{}".format(lst_2))
lst_3 = lst_2+["龙"]*6
print("lst_2+[龙]*6->{}".format(lst_3))
lst_3[9] = 2015
print("lst_3[13]=2015->{}".format(lst_3))
lst_3[-6:-3] = list(range(100,  2))
...
lst_s_2.append(list(range(50, 70, 5)))
...
lst_s_2.insert(2, [1000, 12001500])
...
print("3*(20*3,)->{}".format(3*(25*3,)))
print("tuple((5,8,9))->{}".format(tuple((5,7,9)))) 
print("tuple([5,8,9])->{}".format(tuple([5,7,9]))) 
...
dic[3]=(random.random(),random.uniform(150,300))
...
dic_update={8:[5,7,6,3,2],9:[3,2,22,66]}
...
new_str_3=format_str_3%(pi,pi,pi,"Hello Python!",5,"Hello Python!",50,52,pi)
...
print("match_2.group(2)->{}".format(match_2.group(1)))


lst=list(range(15,30,3))
...
nested_list=[[a for a in range(1,9,3)],2,3,[b for b in range(50,80,7)],[[c for c in range(800,1700,100)],3,9]]
...
print("3 not in x->{}".format(2 not in x))
...
def fibonacci(s,count):
    ...
    if s==0 or s==3:
        ...
        for i in range(count-3):
            fib_part.append(fib_part[-1]+fib_part[-3])
    else:
        while True:
...
print("fibonacci(6,9)->{}".format(fibonacci(5,9)))
print("fibonacci(7,9)->{}".format(fibonacci(6,9)))
...
print("f_convert_a(3,6,7)->{}".format(f_convert_a((2,5,7))))
...
print("f_convert_b(3,6,7)->{}".format(f_convert_b((2,5,7))))  
...
print("f_convert_c(3,6,7)->{}".format(f_convert_c((2,5,7))))         
...
print("f_convert_d(3,6,7)->{}".format(f_convert_d((2,5,7)))) 
...
print("f_convert_e(3,6,7)->{}".format(f_convert_e((2,5,7))))    
...
print("f_convert_f(3,6,7)->{}".format(f_convert_f((2,5,7))))     
